...
//       if (xhr.status === 200) {
//         loadJolie();
//         // window.location.href = `display.html?first_name=${first_name}&last_name=${last_name}&email=${email}&password=${password}&confirm_password=${confirm_password}`;
//       } else {
...
//       if (xhr.status === 200) {
//         loadJolie();
//         // window.location.href = `edit.html?first_name=${first_name}&last_name=${last_name}&email=${email}&password=${password}&confirm_password=${confirm_password}`;
//       } else {
...
//       if (xhr.status === 200) {
//         loadJolie();
//         // window.location.href = `delete.html?first_name=${first_name}&last_name=${last_name}&email=${email}&password=${password}&confirm_password=${confirm_password}`;
//       } else {
